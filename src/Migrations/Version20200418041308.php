...
final class Version20200418041308 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE SEQUENCE placeto_pay_integration_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE orders (id SERIAL NOT NULL, customer_id INT NOT NULL, code VARCHAR(255) DEFAULT NULL, total_to_pay DOUBLE PRECISION NOT NULL, status VARCHAR(20) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE customers (id SERIAL NOT NULL, name VARCHAR(80) NOT NULL, surname VARCHAR(80) NOT NULL, email VARCHAR(120) NOT NULL, mobile VARCHAR(40) NOT NULL, address VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE placeto_pay_integration (id INT NOT NULL, request_id INT NOT NULL, process_url VARCHAR(255) NOT NULL, order_id INT NOT NULL, order_code VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP SEQUENCE placeto_pay_integration_id_seq CASCADE');
        $this->addSql('DROP TABLE products');
        $this->addSql('DROP TABLE orders_detail');
        $this->addSql('DROP TABLE orders');
        $this->addSql('DROP TABLE customers');
        $this->addSql('DROP TABLE categories');
        $this->addSql('DROP TABLE placeto_pay_integration');
    }
}
